...
throttle = ttk.Progressbar(w, orient='vertical', length=290, mode='determinate', value=0)
brake = ttk.Progressbar(w, orient='vertical', length=290, mode='determinate', value=0)
barSpacing = 10
PPIxRef = screenWidth - (2 * (barSpacing + throttle.winfo_reqwidth()))
PPIyRef = screenHeight - ((2 * barSpacing) + throttle.winfo_reqheight() + 35)
